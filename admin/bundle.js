  ...
  _createClass(Editor, [{
    ...
    value: function enableEditing() {
      this.iframe.contentDocument.body.querySelectorAll("text-editor").forEach(function (element) {
        ...
        var virtualElement = DOMHelper.virtualDom.body.querySelector("[nodeid=\"".concat(id, "\"]"));
    ...
    value: function injectStyles() {
      ...
      style.innerHTML = "\n      text-editor:hover {\n        outline: 2px dotted #6DA839;\n        outline-offset: 10px;\n        color: rgba(#6DA839, 0.5);\n      }\n      text-editor:focus {\n        outline: 3px solid #A8396D;\n        outline-offset: 10px;\n        color: rgba(#A8396D, 0.5);\n      }\n    ";
